...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipNav">
            ...
            <a href="${pageContext.request.contextPath}/login/pass" class="on">修改密码</a>
        </div>
        <div id="vipRight">
...
<script>
    $(".con").click(function(){
        ...
        $.ajax({
           type:"POST",
           url:"${pageContext.request.contextPath}/login/upass.do",
           data:{
               "password":xin
           },
            success:function (result) {
                ...
                top.location.href = "${pageContext.request.contextPath}/login/loginPage";
            }
        });
    });
</script>
