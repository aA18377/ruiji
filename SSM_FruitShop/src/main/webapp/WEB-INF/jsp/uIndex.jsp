...
<div class="width100" style="height: 45px;background: #dd4545;margin-top: 40px;position: relative;z-index: 100;">
    ...
    <div class="width1200 center_yh relative_yh" style="height: 45px;">
        ...
        <div class="left_yh Selected" style="width: 230px;height: 45px;" id="hiddenShow">
            <!--头部的图标-->
            <img src="${pageContext.request.contextPath}/reourcesHtml/user/images/cd.png" class="left_yh" style="margin-left: 24px;" alt="">
            <span class="block_yh left_yh fff" style="height: 45px;line-height: 44px;margin-left: 10px;">分类</span>
            <!--导航展开部分-->
            <div class="downSlide">
                <c:forEach items="${lbs}" var="data" varStatus="ll">
                    <div class="n1Nav">
                        <font>${data.father.name}</font>
                        <img src="${pageContext.request.contextPath}/reourcesHtml/user/images/jt.png" alt="">
                        <div class="n2Nav">
                            <div class="n3Nav">
                                <h3>${data.father.name}</h3>
                                <c:forEach items="${data.childrens}" var="child" varStatus="l">
                                    <a href="${pageContext.request.contextPath}/item/shoplist?categoryIdTwo=${child.id}">${child.name}</a>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
...
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index:80;">
    <div class="example2" style="width: 1200px;height: 490px;overflow: hidden;margin-left: 230px;">
        <ul>
            <li><img src="${pageContext.request.contextPath}/reourcesHtml/images/a.webp" alt=""></li>
            <li><img src="${pageContext.request.contextPath}/reourcesHtml/images/b.webp" alt=""></li>
            <li><img src="${pageContext.request.contextPath}/reourcesHtml/images/c.webp" alt=""></li>
            <li><img src="${pageContext.request.contextPath}/reourcesHtml/images/d.webp" alt=""></li>
        </ul>
    </div>
    <script>
        $(function () {
