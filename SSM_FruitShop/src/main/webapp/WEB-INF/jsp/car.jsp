...
<div class="width1198 hidden_yh center_yh" style="border: 1px solid #ddd;margin-top: 18px;min-height: 300px;">
    ...
    <c:forEach items="${list}" var="data" varStatus="l">
        <div class="speCific" data-id="${data.id}">
            <div class="xzWxz">
                <b><img src="${pageContext.request.contextPath}/reourcesHtml/user/images/xzwxz.png"></b>
            </div>
            <div class="xzSp">
...
<div class="width1198 center_yh" style="height: 60px;background: #f0f0f0;border:1px solid #ddd;margin-top:40px;">
    <div class="center_yh hidden_yh" style="width: 1178px;height: 60px;margin-left: 20px;">
        <div class="ifAll"><b><img src="${pageContext.request.contextPath}/reourcesHtml/user/images/xzwxz.png"></b><font>全选</font></div>
...
<script>
    ...
    $(".Dels").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/car/delete?id=" + id,
    ...
    function ifJs() {
        ...
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/itemOrder/exAdd",
