...
<div class="width1198 center_yh" style="height: 420px;">
    ...
    <div class="left_yh" style="width: 486px;height: 420px;margin-left: 42px;">
        ...
        <div class="buyFor">
            <a href="${pageContext.request.contextPath}/sc/exAdd?itemId=${obj.id}" class="mstBuy">收藏</a>
                ...
                <div class="width100 hidden_yh" style="padding-bottom: 20px;border-bottom: 1px dashed #ddd; margin-bottom: 10px;">
                    <c:forEach items="${obj.pls}" var="data" varStatus="l">
                        <div style="width: 790px;float: right;overflow:hidden;margin-top: 20px;">
                            <img src="${pageContext.request.contextPath}/reourcesHtml/user/images/x.jpg" style="width: 40px;height: 40px;border-radius: 50%;float: left;border:1px solid #ddd;margin-top: 20px;margin-right: 30px;">
...
<script>
    ...
    $(".addCar").click(function () {
        ...
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/car/exAdd?itemId="+id+"&num="+num,
