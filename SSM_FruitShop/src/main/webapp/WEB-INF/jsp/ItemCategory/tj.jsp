...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   ...
   <title>后台管理中心</title>  
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/reourcesHtml/css/common.css"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/reourcesHtml/css/main.css"/>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/reourcesHtml/css/reset.css" />
	<link rel="stylesheet" href="${pageContext.request.contextPath}/reourcesHtml/css/style.css" />
	<script src="${pageContext.request.contextPath}/reourcesHtml/js/Ecalendar.jquery.min.js"></script>
	
	<script src="${pageContext.request.contextPath}/reourcesHtml/js/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/reourcesHtml/js/echarts.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/reourcesHtml/js/macarons.js"></script>
</head>
<body>
