...
<body>
<div class="width100 hidden_yh" style="height: 573px;background: url('${pageContext.request.contextPath}/reourcesHtml/user/images/bj.jpg') no-repeat center">
    <div class="width1200 hidden_yh center_yh" style="margin-top: 75px">
        <div class="right_yh bj_fff" style="width:408px;height: 438px;">
            <form action="${pageContext.request.contextPath}/login/utoLogin" method="post">
                ...
                <div class="center_yh hidden_yh" style="width: 336px;">
                    <div class="width100 box-sizing hidden_yh" style="height: 44px;border:1px solid #c9c9c9;margin-bottom: 34px;">
                        <img src="${pageContext.request.contextPath}/reourcesHtml/user/images/rw.jpg" alt="" class="left_yh" width="42" height="42">
                    ...
                    <div class="width100 box-sizing hidden_yh" style="height: 44px;border:1px solid #c9c9c9;margin-bottom: 34px;">
                        <img src="${pageContext.request.contextPath}/reourcesHtml/user/images/pass.jpg" alt="" class="left_yh" width="42" height="42">
