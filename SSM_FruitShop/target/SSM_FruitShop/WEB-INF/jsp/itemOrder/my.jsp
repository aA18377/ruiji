...
<div class="width1200 center_yh hidden_yh font14" style="height: 40px;line-height: 40px;">
    <span>当前位置：</span><a href="${pageContext.request.contextPath}/login/uIndex" class="c_66">首页</a>
...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipNav">
            <a href="${pageContext.request.contextPath}/user/view">个人信息</a>
            <a href="${pageContext.request.contextPath}/itemOrder/my" class="on">我的订单</a>
            <a href="${pageContext.request.contextPath}/sc/findBySql">商品收藏</a>
            <a href="${pageContext.request.contextPath}/login/pass">修改密码</a>
        </div>
        <div id="vipRight">
            <div style="width: 938px;border:1px solid #ddd;background: #fff;">
                        ...
                        <div class="width100 hidden_yh">
                                ...
                                <div style="width: 838px;border-bottom: 1px dashed #ddd;padding-top: 30px;padding-bottom: 30px;" class="hidden_yh center_yh">
                                    ...
                                    <div class="right_yh">
                                        <c:if test="${data.status==3}">
                                            <a href="${pageContext.request.contextPath}/itemOrder/pj?id=${chil.itemId}" class="onfff block_yh tcenter font16 onHoverr" style="margin-top: 10px;padding-right: 6px;">
                                                去评价
                                            </a>
                                        </c:if>
                                    </div>
                            ...
                            <div style="width: 838px;padding-top:30px;padding-bottom: 30px;" class="hidden_yh center_yh tleft">
                                ...
                                <c:if test="${data.status==0}">
                                    <a href="${pageContext.request.contextPath}/itemOrder/qx?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top: 10px;padding-right: 6px;">
                                        取消订单
                                    </a>
                                </c:if>
                                ...
                                <c:if test="${data.status==2}">
                                    <a href="${pageContext.request.contextPath}/itemOrder/sh?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top: 10px;padding-right: 6px;">
                                        去收货
                                    </a>
                                </c:if>
                                <c:if test="${data.status==3}">
                ...
                <!--已收货-->
                <div class="allGoods width100 hidden_yh hhD" style="display: none;">
                    <c:forEach items="${pageContext.request.contextPath}" var="data" varStatus="l">
                        <div class="width100 hidden_yh">
                            <div class="width100 hidden_yh fon20 c_66" style="background:#faf5f5;text-indent: 47px;height: 50px;line-height: 50px;border-bottom: 1px solid #ddd;">
                                <fmt:formatDate value="${data.addTime}" type="both"/>&nbsp;&nbsp;订单号${data.code}&nbsp;&nbsp;
                                <c:if test="${data.status==0}">待发货</c:if>
