...
<div class="panel admin-panel">
    <div class="padding border-bottom">
        <ul class="search" style="padding-left: 10px;">
            <li>
                <a class="button border-main icon-plus-square-o" href="${pageContext.request.contextPath}/itemCategory/add">新增类目</a>
            </li>
        </ul>
    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="button-group">
                        <a class="button border-main" href="${pageContext.request.contextPath}/itemCategory/findBySql2?pid=${data.id}"><span class="icon-edit">查看二级分类</span> </a>
                        <a class="button border-main" href="${pageContext.request.contextPath}/itemCategory/update?id=${data.id}"><span class="icon-edit">修改</span> </a>
                        <a class="button border-red" href="${pageContext.request.contextPath}/itemCategory/delete?id=${data.id}"><span class="icon-trash-o">删除</span> </a>
                    </div>
                </td>
            </tr>
        </c:forEach>
