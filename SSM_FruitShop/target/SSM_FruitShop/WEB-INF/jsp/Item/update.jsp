...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form action="${pageContext.request.contextPath}/item/exUpdate" method="post" class="form-x" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <select name="categoryIdOne" class="input w50">
                        <c:forEach items="${types}" var="data" varStatus="l">
                            <option value="${data.id}" ${obj.categoryIdOne == data.id?"selected":""}>${data.name}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
